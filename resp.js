...
const App = () => {
  ...
  return (
    ...
    React.createElement("div", { ref: swearRef, className: "bear__swear" }, "#@$%*!"), 
    ...
    React.createElement("g", { id: "layer1", transform: "translate(-7.5271369,-761.38595)" }, 
    ...
    React.createElement("g", { id: "g5681" }, 
    ...
    React.createElement("g", { transform: "matrix(-1,0,0,1,300,0)", id: "g5685" }, 
    React.createElement("ellipse", {
      ry: "33.289474",
      rx: "34.5",
      cy: "823.07269",
    ...
    React.createElement("div", { ref: armWrapRef, className: "bear__arm-wrap" }, 
    React.createElement("svg", {
      ref: armRef,
      className: "bear__arm",
      viewBox: "0 0 250.00001 99.999997",
      preserveAspectRatio: "xMinYMin" }, 
    React.createElement("g", { transform: "translate(868.57141,-900.93359)", id: "layer1" }, 
    React.createElement("path", {
      style: { fill: '#784421', fillOpacity: 1 },
    ...
    React.createElement("div", { ref: pawRef, className: "bear__paw" }), 
    React.createElement("div", { className: "mask" }), 
    React.createElement("div", { className: "checkbox", onMouseOver: onHover, onMouseOut: offHover }, 
    React.createElement("input", { type: "checkbox", onChange: onChange, checked: checked }), 
    React.createElement("div", { ref: bgRef, className: "checkbox__bg" }), 
